...
public class SimulationWindow {
	...
	private void initialize() {
		...
		JButton suspectBtn = new JButton("Last suspect");
		suspectBtn.addActionListener(new ActionListener()
		{
			  public void actionPerformed(ActionEvent e)
			  {
				  System.out.println("perfoming action");
				  algo1.return_suspect = !algo1.return_suspect;
				  algo1.speedDown();
				  algo1.spinBy(180, true, new Func() {
						@Override
						public void method() {
		...
		suspectBtn.setBounds(1700, 400, 120, 50);
		frame.getContentPane().add(suspectBtn);
	...
	public void main() {
		...
		Map map = new Map("C:\\Users\\yinon\\Desktop\\Maps\\p1" + map_num + ".png",startPoints[map_num-1]);
